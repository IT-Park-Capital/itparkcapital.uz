  ...
  },
  {
    ...
    content: {
      uz: {
        ...
        intro: "Zero Risk — IT va BPO kompaniyalarni O'zbekistonga jalb qilishga qaratilgan davlat dasturi bo'lib, IT-kompaniyalarga start bosqichida moliyaviy xatarlarni minimallashtirgan holda o'sish va kengayish imkonini beradi. Dasturning asosiy maqsadi — IT va BPO kompaniyalarga O'zbekiston bozoriga kirish va minimal xatarlar bilan kengayish imkoniyatini yaratish.",
        benefits: [
          "12 oygacha barcha hududlarda bepul ofis maydonlari (Toshkentdan tashqari)",
          "Texnik jihozlar bilan ta'minlash (12 oydan so'ng sotib olish huquqi bilan)",
          "Ish haqi kompensatsiyasi — har bir yangi xodim uchun 15% gacha",
          "Xodimlarni o'qitish xarajatlari kompensatsiyasi — 50% gacha (bir kurs uchun $6 000 dan oshmagan holda)",
          "Xodimlarni yollash xarajatlari kompensatsiyasi — 15% gacha (har bir xodim uchun $600 dan oshmagan holda)",
        ],
        criteria: [
        ...
        results: [
          { value: '81', label: "qabul qilingan ariza" },
          { value: '66', label: "qabul qilingan kompaniya" },
          { value: '1 500+', label: "yaratilgan ish o'rni" },
          { value: '2 500', label: "yil oxiriga rejalashtirilgan ish o'rni" },
          { value: '$700K+', label: "xarid qilingan jihozlar qiymati" },
          { value: '$29M+', label: "yillik eksport hajmi" },
        ],
      },
      ru: {
        kind: 'zero-risk',
        ...
        benefits: [
          ...
          "Оснащение техническим оборудованием (с правом выкупа через 12 месяцев)",
          "Компенсация заработной платы — до 15% на каждого нового сотрудника",
          "Компенсация расходов на обучение сотрудников — до 50% (но не более $6 000 на курс)",
          "Компенсация расходов на подбор персонала — до 15% (не более $600 на сотрудника)",
        ],
        criteria: [
          "Более 50% выручки благодаря экспорту IT-услуг",
          "Действующий экспортный контракт на сумму от $500 000+",
          "Оборот головной компании — от $1 млн",
        ],
        results: [
          { value: '81', label: "принятая заявка" },
          { value: '66', label: "принятых компаний" },
          { value: '1 500+', label: "созданных рабочих мест" },
          { value: '2 500', label: "рабочих мест к концу года" },
          { value: '$700K+', label: "стоимость оборудования" },
          { value: '$29M+', label: "годовой объём экспорта" },
        ],
      },
      en: {
        kind: 'zero-risk',
        ...
        benefits: [
          ...
          "Provision of technical equipment (with the option to purchase after 12 months)",
          "Salary subsidy — up to 15% per new employee",
          "Reimbursement of staff training costs — up to 50% (but not exceeding $6,000 per course)",
          "Reimbursement of recruitment costs — up to 15% (up to $600 per employee)",
        ],
        criteria: [
        ...
        results: [
          { value: '81', label: "applications accepted" },
          { value: '66', label: "companies accepted" },
          { value: '1,500+', label: "jobs created" },
          { value: '2,500', label: "jobs planned by year-end" },
          { value: '$700K+', label: "equipment value" },
          { value: '$29M+', label: "annual export volume" },
        ],
      },
    },
  },
